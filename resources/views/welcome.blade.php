...
<html  lang="{{ app()->getLocale() }}">
	<head>
		...
		<title>Car Insurance | Management System</title>
	...
	<body id="home">
					...
					<div class="row">
						...
						<div class="col-md-6 col-sm-12">
                            ...
                            @if (Route::has('login'))
                                ...
                                @else
                                <h4><a href="{{ route('login') }}">Login</a> </span><a href="{{ route('register') }}">Register</a></span></h4>
		...
		<section class="offer">
			<div class="container">
				<h2>50% Off on Your Car Insurance Renevals</h2>
			...
			<div class="container">
				<div class="row">
					<div class="col-md-6 col-sm-8">
						<p>Designed With <span class="fa fa-heart" aria-hidden="true"></span> by Victor Alagwu</p>
					</div>
